...
describe('AssessmentsController', () => {
  ...
  it('should update SubmittedAssessment', async () => {
    ...
    jest
      .spyOn(service, 'updateSubmittedAssessment')
      .mockImplementation(() => of(mockResponse));

    controller
      .updateSubmittedAssessment(mockAssessmentId, existingAssessment as any)
      .subscribe((response) => {
        expect(service.updateSubmittedAssessment).toHaveBeenCalledWith(
          mockAssessmentId,
          existingAssessment
        );
